...
/**
 * Contains core game logic and rule validation for the Nim game (Misère
 * variant).
 * Handles turn validation, next player determination, and winner calculation.
 */
public class GameRules {
    ...
    /**
     * Validates a player's move according to the game rules:
     * - The game must still be running.
     * - Token count must be between 1 and 3.
     * - Player cannot take more tokens than remain in the game.
     *
     * @param game The current game state
     * @param turn The turn the player attempts to make
     * @return A validation result indicating whether the turn is valid or invalid,
     *         with reason
     */
    ...
    /**
     * Returns the player who should take the next turn,
     * alternating between COMPUTER and HUMAN.
     *
     * @param game The current game state
    ...
    /**
     * Determines the winner of the game when it ends.
     * In the Misère variant, the player who did NOT make the last move wins.
     *
